...
public:
    void InpSubjects() {//a function where user inputs his/her subjects
        ...
        for (int i = 0; i < sizeSub; i++) {
            cout << "Enter the name for subject \033[4m#" << i + 1 << "\033[0m: ";
            getline(cin, subjects[i]);//User will input their subjects here

            for (int j = 0; j < i; j++) {
                if (subjects[i] == subjects[j]) {
                    cout << "\033[31mYou already entered this subject.\033[0m\n";
                    i--;
                }
    ...
    void RestSubjects() {//A function that asks a user if he/she is certain to its given subjects
        string pick;
        cout << endl;
        cout << "Are these your final subjects? Type \033[1;4m'Yes'\033[0m or \033[1;4m'yes'\033[0m to proceed,\n";
        cout << "or \033[1;4m'No'\033[0m or \033[1;4m'no'\033[0m to redo your subjects.\n";
        ...
        if (pick == "Yes" || pick == "yes") {//proceeds to the next function
            ...
            cout << "\033[5mInvalid match. Pls Try Again!\033[0m\n";
            RestSubjects();
        }
    ...
    void DispSubjects() { //Will be used to display subjects
        cout << "======================================================\n\n";
        cout << "\t\033[4mSubjects:\033[0m\n\n";
        for (int i = 0; i < storeSizeSubjects; i++) {
            cout << "\033[7m- " << storeSubjects[i] << "\033[0m" << endl;
        }
    }
    ...
    void InpProcessSubject() {//a function used for inputting what subject you want to process
        ...
        cout << "\033[4m\"Science\"\033[0m and \033[4m\"science\"\033[0m are considered different subjects.\n";
        ...
        if (flag) {
            ...
            while (res) {
                ...
                if (term == 1) {
                    ...
                    cout << "\n";
                    cout << "\033[5mInvalid Match. Try Again!\033[0m\n";
                    res = true;
                }
            ...
            cout << endl;
            cout << "\033[31mYour input does not match any of the subjects you provided. Please try again.\033[0m";
            InpProcessSubject();
        }
    ...
    void PerformScoresOP() {//a function used to compute all the scores and grades
        cout << "======================================================\n";
        cout << "\033[7mPercentage Grade\033[0m      \033[7mGrade Point\033[0m  \t\033[7mDescription\n\t\t\033[0m       \033[7mEquivalent\t\n\n\033[0m";
        cout << "\033[32m96.50 - 100%\t\t 1.00\t\t Excellent\n";
        cout << "92.50 - 96.49%\t\t 1.25\t\t Superior\n";
        cout << "88.50 - 92.49%\t\t 1.50\t\t Very Good\n";
        cout << "84.50 - 88.49%\t\t 1.75\t\t Good\n\033[0m";
        cout << "\033[33m79.50 - 84.49%\t\t 2.00\t\t Above Average\n";
        cout << "74.50 - 79.49%\t\t 2.25\t\t Average\n";
        cout << "69.50 - 74.49%\t\t 2.50\t\t Fairly Satisfactory\033[0m\n";
        cout << "\033[31m64.50 - 69.49%\t\t 2.75\t\t Fair\n";
        ...
        if (Term == 1 || Term == 2 || Term == 3) {
            ...
            while (rest1) {
                ...
                if (numAT == 0) {
                    cout << "\033[5mYou did not process any scores on your assessment tasks\033[0m\n";
                    cout << endl;
                    ...
                    for (int i = 0; i < numAT; i++) {
                        double score1;
                        cout << "Enter the score for assessment task \033[4m#" << i + 1 << "\033[0m: ";
                        cin >> score1;
                        totalAssessmentTaskScore += score1;
                        cout << "Enter how many items on this assessment task \033[4m#" << i + 1 << "\033[0m: ";
                        cin >> maxAssessmentTaskScore;

                        while (maxAssessmentTaskScore < score1) {
                            cout << "\033[31mYOUR ITEMS SHOULD BE HIGHER THAN YOUR SCORE.\033[0m\n";
                            cout << "Enter how many items on this assessment task \033[4m#" << i + 1 << "\033[0m: ";
                            cin >> maxAssessmentTaskScore;
                        }
                        cout << endl;
                ...
                cout << "Is this final? Type \033[1;4m'Yes'\033[0m or \033[1;4m'yes'\033[0m to proceed,\n";
                cout << "or \033[1;4m'No'\033[0m or \033[1;4m'no'\033[0m to redo your scores.\n";
                while (rest1_2) {
                    cout << "Type your response here: ";
                    getline(cin, pick1);
                    if (pick1 == "Yes" || pick1 == "yes") {//proceeds to the next function
                        ...
                        cout << "\n\033[5mInvalid match. Pls Try Again!\033[0m\n\n";
                        rest1_2 = true;
                    }
            ...
            cout << endl;
            if (numAT == 0) {
                cout << "Your assessment task grade will be automatically: \033[4m" << fixed << setprecision(2) << show1 << "%\033[0m" << endl;
            }
            else if (numAT != 0) {
                cout << "Computation: (" << fixed << setprecision(0) << totalAssessmentTaskScore << " / " << totalmaxATscore << ")(0.1) = " << fixed << setprecision(2) << show1 << endl;
                cout << "\033[32mYour total assessment task score is " << fixed << setprecision(0) << totalAssessmentTaskScore << "/" << totalmaxATscore << " which is equal to " << fixed << setprecision(2) << show1 << "%.\033[0m\n";
            }
            ...
            while (rest2) {
                ...
                if (numLQ == 0) {
                    cout << "\033[5mYou did not process any scores on your long quizzes\033[0m\n";
                    cout << endl;
                }
                else if (numLQ != 0) {
                    for (int i = 0; i < numLQ; i++) {
                        double score2;
                        cout << "Enter the score for long quiz \033[4m#" << i + 1 << "\033[0m: ";
                        cin >> score2;
                        totalLongQuizScore += score2;
                        cout << "Enter how many items on this long quiz \033[4m#" << i + 1 << "\033[0m: ";
            ...
            cout << endl;
            if (numLQ == 0) {
                cout << "Your long quiz grade will be automatically: \033[4m" << fixed << setprecision(2) << show2 << "%\033[0m" << endl;
            }
            else if (numLQ != 0) {
                cout << "Computation: (" << fixed << setprecision(0) << totalLongQuizScore << " / " << totalmaxLQscore << ")(0.25) = " << fixed << setprecision(2) << show2 << endl;
                cout << "\033[32mYour total long quiz score is " << fixed << setprecision(0) << totalLongQuizScore << "/" << totalmaxLQscore << " which is equal to " << fixed << setprecision(2) << show2 << "%.\033[0m\n";
            }

            cout << "\n======================================================\n";
            //for short quiz
            cout << "\033[7m\n-Short Quiz(15%)\033[0m";
            while (rest3) {
                ...
                if (numSQ == 0) {
                    cout << "\033[5mYou did not process any scores on your short quizzes\033[0m\n";
                    cout << endl;
                    ...
                    for (int i = 0; i < numSQ; i++) {
                        double score3;
                        cout << "Enter the score for short quiz \033[4m#" << i + 1 << "\033[0m: ";
                        cin >> score3;
                        totalShortQuizScore += score3;
                        cout << "Enter how many items on this short quiz \033[4m#" << i + 1 << "\033[0m: ";
                ...
                while (rest3_2) {
                    ...
                    if (pick3 == "Yes" || pick3 == "yes") {//proceeds to the next function
                        ...
                        //if user type that is not given in the program it will generate an error message 
                        cout << "\033[5m\nInvalid match. Pls Try Again!\033[0m\n\n";
                        rest3_2 = true;
                    }
            ...
            cout << endl;
            if (numSQ == 0) {
                cout << "Your short quiz grade will be automatically: \033[4m" << fixed << setprecision(2) << show3 << "\033[0m%" << endl;
            }
            else if (numSQ != 0) {
                cout << "Computation: (" << fixed << setprecision(0) << totalShortQuizScore << " / " << totalmaxSQscore << ")(0.15) = " << fixed << setprecision(2) << show3 << endl;
                cout << "\033[32mYour total short quiz score is " << fixed << setprecision(0) << totalShortQuizScore << "/" << totalmaxSQscore << " which is equal to " << fixed << setprecision(2) << show3 << "%.\033[0m\n";
            }
            ...
            while (rest4) {
                ...
                if (numExams == 0) {
                    cout << "\033[5mYou did not process any scores on your exams\033[0m\n";
                    cout << endl;
                }
                else if (numExams != 0) {
                    for (int i = 0; i < numExams; i++) {
                        double score4;
                        cout << "Enter the score for this exam \033[4m#" << i + 1 << "\033[0m: ";
                        cin >> score4;
                        totalExamScore += score4;
                        cout << "Enter how many items on this exam \033[4m#" << i + 1 << "\033[0m: ";
                        cin >> maxExamScore;
            ...
            cout << endl;
            if (numExams == 0) {
                cout << "Your exam grade will be automatically: \033[4m" << fixed << setprecision(2) << show4 << "%\033[0m" << endl;
            }
            else if (numExams != 0) {
                cout << "Computation: (" << fixed << setprecision(0) << totalExamScore << " / " << totalmaxExamscore << ")(0.5) = " << fixed << setprecision(2) << show4 << endl;
                cout << "\033[32mYour total exam score is " << fixed << setprecision(0) << totalExamScore << "/" << totalmaxExamscore << " which is equal to " << fixed << setprecision(2) << show4 << "%.\033[0m\n";
            }
            ...
            if (Term == 1) {
                ...
                cout << "\033[1mComputation: " << show1 << " + " << show2 << " + " << show3 << " + " << show4 << " = " << PMPFGrade << "\033[0m\n";
                cout << "\033[7mYour Prelim grade on this subject is \033[4m" << PrelimGrade << "\033[0m\n";
                ...
                cout << "\033[7mYour Prelim grade equivalent is: \033[4m" << PrelimGradeEQ << "\033[0m\n";
                cout << "\033[7mYour Prelim grade description: \033[4m" << PrelimDescription << "\033[0m\n";
                cout << endl;
                cout << "======================================================\n\n";
            }
            else if (Term == 2) {
                ...
                cout << "\033[1mComputation: " << show1 << " + " << show2 << " + " << show3 << " + " << show4 << " = " << PMPFGrade << "\033[0m\n";
                cout << "\033[7mYour Midterm grade on this subject is \033[4m" << MidtermGrade << "\033[0m\n";
                ...
                cout << "\033[7mYour Midterm grade equivalent is: \033[4m" << MidtermGradeEQ << "\033[0m\n";
                cout << "\033[7mYour Midterm grade description: \033[4m" << MidtermDescription << "\033[0m\n";
                cout << endl;
                cout << "======================================================\n\n";
            }
            else if (Term == 3) {
                ...
                cout << "\033[1mComputation: " << show1 << " + " << show2 << " + " << show3 << " + " << show4 << " = " << PMPFGrade << "\033[0m\n";
                cout << "\033[7mYour Prefinal grade on this subject is \033[4m" << PrefinalGrade << "\033[0m\n";
                ...
                cout << "\033[7mYour Prefinal grade equivalent is: \033[4m" << PrefinalGradeEQ << "\033[0m\n";
                cout << "\033[7mYour Prefinal grade description: \033[4m" << PrefinalDescription << "\033[0m\n";
                cout << endl;
                cout << "======================================================\n\n";
            ...
            while (rest1) {
                ...
                cout << endl;
                cout << "Are these your final grades? Type \033[1;4m'Yes'\033[0m or \033[1;4m'yes'\033[0m to proceed,\n";
                cout << "or \033[1;4m'No'\033[0m or \033[1;4m'no'\033[0m to redo your subjects.\n";
                while (rest2) {
                    cout << "Type your response here: ";
                    getline(cin, pick);
                    if (pick == "Yes" || pick == "yes") {//proceeds to the next function
                        ...
                        //if user type that is not given in the program it will generate an error message 
                        cout << endl;
                        cout << "\033[31mInvalid match. Please Try Again!\033[0m\n";
                        rest2 = true;
                    }
            ...
            cout << "\033[1mComputation: \033[32m" << PrelimGrade << "\033[0m(0.3) + \033[32m" << MidtermGrade << "\033[0m(0.3) + \033[32m" << PrefinalGrade << "\033[0m(0.4) = \033[32m" << fixed << setprecision(2) << FinalGrade << "\033[0m\n";
            cout << "\033[7mYour Final grade in this subject is: \033[4m" << fixed << setprecision(2) << FinalGrade << "\033[0m\n";
            ...
            cout << "\033[7mYour Final grade equivalent is: \033[4m" << FinalGradeEQ << "\033[0m\n";
            cout << "\033[7mYour Final grade description: \033[4m" << FinalDescription << "\033[0m\n";
            cout << endl;
            cout << "======================================================\n\n";
        ...
        while (res) {
            ...
            if (pick == 1) {
                while (rest) {
                    ...
                    if (pick2 == 1) {
                        ...
                        if (prelimGradesFile.is_open()) {
                            ...
                            cout << "\n\033[32mGrades and Subjects written in prelimgrades.txt successfully.\033[0m\n\n";
                            prelimGradesFile.close();
                        }
                        else {
                            cout << "\033[41mThe file can't be opened.\033[0m";
                            return;
                        }
#ifdef _WIN32
                        //windows platform
                        ...
                        if (midtermGradesFile.is_open()) {
                            ...
                            cout << "\n\033[32mGrades and Subjects written in midtermgrades.txt successfully.\033[0m\n\n";
                            midtermGradesFile.close();
                        }
                        else {
                            cout << "\033[31mThe file can't be opened.\033[0m";
                            return;
                        }
#ifdef _WIN32
                        //windows platform
                        ...
                        if (prefinalGradesFile.is_open()) {
                            ...
                            cout << "\033[32m\nGrades and Subjects written in prefinalgrades.txt successfully.\033[0m\n\n";
                        ...
                        if (finalGradesFile.is_open()) {
                            ...
                            cout << "\033[32m\nGrades and Subjects written in finalgrades.txt successfully.\033[0m\n\n";
                        ...
                        if (allGradesFile.is_open()) {
                            ...
                            cout << "\033[32m\nGrades and Subjects written in allGrades.txt successfully.\033[0m\n\n";
                            allGradesFile.close();

                        }
                        else {
                            cout << "\033[0m31The file can't be opened.\033[0m";
                            return;
                        }
#ifdef _WIN32
                        //windows platform
                        ...
                        cout << endl;
                        cout << "\033[31mYou did not type any of the given numbers. Try again.\033[0m";
                        rest = true;
                        continue;
                    }
                    ...
                    while (rest2) {
                        ...
                        if (pick3 == "Yes" || pick3 == "yes") {
                            ...
                            cout << endl;
                            cout << "\033[7;5m**Thank you for using our system, we are open for suggestions and criticisms!\033[0m\n";
                            exit(0);
                        }
                        else {
                            cout << endl;
                ...
                if (countSub >= storeSizeSubjects) {
                    cout << endl;
                    cout << "\033[31mYou have no more subjects to process!\033[0m\n\n";
                    res = true;
                }
                else {
                    DispSubjects();
...
int main() {
    ...
    cout << "\033[7m----------[STUDENT REPORT MANAGEMENT SYSTEM]----------\033[0m\n\n";
    cout << "======================================================\n\n";
    cout << "\033[5;31mNote:(IMPORTANT)\033[0m\n";
    cout << "\033[31m*\033[0mPlease enter the right input or it may cause the program terminate abnormally,\n there will be guidelines that will help you.\n\n";
    cout << "\033[31m*\033[0mThere will be times that you will be asked to enter numbers,\n do not enter letters and character symbols on that given statement,\n";
